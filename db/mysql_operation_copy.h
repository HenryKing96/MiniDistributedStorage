...
public:
    ...
    */
    ...
    // 查看文件是否已经上传 (但此处有疑问，用文件名的话，如果是重名文件怎么办，比如 "未命名.jpg")
    ...
    // 创建名为file_name的表
    void db_add_file_table(std::string file_name){
    ...
    void db_add_file_row(std::string file_name, int block_num, std::string file_md5){
    ...
    void create_file(std::string file_name, int block_num, std::string file_md5){
    ...
    bool check_upload_status(std::string file_name){
    ...
    void db_add_block_row(std::string file_name, int block_id, std::string block_md5){
    ...
    void set_block_md5(std::string file_name, std::string md5_string){
        int block_id = 0;
    ...
    void set_block_uploaded(std::string file_name, int block_id){
    ...
    std::string get_block_md5(int block_id, std::string file_name){
    ...
    // 返回上传成功的块组成的id字符串
    std::string get_block_id_string(std::string file_name){
    ...
    int get_block_num(std::string file_name){
    ...
    std::string get_file_block_md5(std::string file_name){
